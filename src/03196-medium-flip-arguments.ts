...
type Reverse<T extends unknown[]> = T extends [infer R, ...infer Rest] ? [...Reverse<Rest>, R] : T
type FlipArguments<T extends (...args: any) => unknown> = T extends (...args: infer R) => infer F
  ? (...args: Reverse<R>) => F
  : never
