...
type ToUnion<T extends string> = T extends `${infer R}${infer N}` ? R | ToUnion<N> : T

type AllCombinations<
  S extends string,
  Union extends string = ToUnion<S>,
  Current extends string = Union,
> = Current extends Union
  ? Current extends ''
    ? ''
    : `${Current}${AllCombinations<'', Exclude<Union, Current>>}`
  : never
