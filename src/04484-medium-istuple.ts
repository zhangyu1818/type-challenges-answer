...
/**
 * the length of a tuple-type array is a specific value
 * such as number extends 2 (tuple length), it will return false.
 * since the length of the array is unknown
 * number extends number (array length), it returns true
 */
