...
type Include<T extends unknown[], U> = T extends [infer R, ...infer Rest]
  ? Equal<R, U> extends true
    ? true
    : Include<Rest, U>
  : false

type Unique<T extends unknown[], Result extends unknown[] = []> = T extends [infer R, ...infer Rest]
  ? Unique<Rest, Include<Result, R> extends true ? Result : [...Result, R]>
  : Result
