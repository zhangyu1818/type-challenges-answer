...
type InitArray<T extends number, Result extends unknown[] = []> = Result['length'] extends T
  ? Result
  : InitArray<T, [...Result, never]>

type NumberRange<
  L extends number,
  H extends number,
  R extends unknown[] = InitArray<L>,
> = R['length'] extends H ? [...R, H][number] : NumberRange<L, H, [...R, R['length']]>
